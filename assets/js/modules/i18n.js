...
export const translations = {
                    ...
                    es: {
                        ...
                        "theme": "Tema",
                        "dark_theme": "Oscuro (Predeterminado)",
                        "light_theme": "Claro",
                        ...
                        "default_session_duration": "Duración Predeterminada de Sesión (horas)",
                        "inventory_settings": "Configuración de Inventario",
                        "default_low_stock_alert": "Umbral Predeterminado de Alerta de Stock Bajo",
                        "low_stock_help": "Se te notificará cuando los artículos alcancen esta cantidad",
                        "auto_deduct_materials": "Deducir automáticamente materiales después de las sesiones",
                        "notifications": "Notificaciones",
                        "enable_notifications": "Habilitar notificaciones",
                        "notifications_help": "Recibe notificaciones sobre próximas sesiones",
                        "session_reminder": "Recordatorio de Sesión (horas antes)",
                        "reminder_help": "Se te notificará esta cantidad de horas antes de que comience una sesión",
                        "test_notifications": "Probar Notificaciones",
                        "data_management": "Gestión de Datos",
                        "auto_save": "Guardar cambios automáticamente",
                        "auto_save_help": "Los cambios se guardan automáticamente en tu navegador",
                        "backup_all_data": "Respaldar Todos los Datos",
                        "import_data": "Importar Datos",
                        "clear_all_data": "Borrar Todos los Datos",
                        "about": "Acerca de",
                        "about_description": "Sistema Profesional de Gestión de Estudios de Tatuajes",
                        "made_with": "Hecho con",
                        "for_artists": "para artistas de tatuajes de todo el mundo",
                    ...
                    ru: {
                        ...
                        "theme": "Тема",
                        "dark_theme": "Тёмная (По умолчанию)",
                        "light_theme": "Светлая",
                        "auto_theme": "Авто (Системная)",
                        ...
                        "default_session_duration": "Продолжительность сеанса по умолчанию (часы)",
                        "inventory_settings": "Настройки инвентаря",
                        "default_low_stock_alert": "Порог оповещения о низком запасе по умолчанию",
                        "low_stock_help": "Вы получите уведомление, когда предметы достигнут этого количества",
                        "auto_deduct_materials": "Автоматически вычитать материалы после сеансов",
                        "notifications": "Уведомления",
                        "enable_notifications": "Включить уведомления",
                        "notifications_help": "Получать уведомления о предстоящих сеансах",
                        "session_reminder": "Напоминание о сеансе (часов до)",
                        "reminder_help": "Вы получите уведомление за это количество часов до начала сеанса",
                        "test_notifications": "Тестировать уведомления",
                        "data_management": "Управление данными",
                        "auto_save": "Автосохранение изменений",
                        "auto_save_help": "Изменения сохраняются автоматически в вашем браузере",
                        "backup_all_data": "Резервное копирование всех данных",
                        "import_data": "Импорт данных",
                        "clear_all_data": "Очистить все данные",
                        "about": "О программе",
                        "about_description": "Профессиональная система управления тату-студией",
                        "made_with": "Сделано с",
                        "for_artists": "для тату-мастеров по всему миру",
                    ...
                    he: {
                        ...
                        "appearance": "מראה",
                        "theme": "ערכת נושא",
                        "dark_theme": "כהה (ברירת מחדל)",
                        "light_theme": "בהיר",
                        "auto_theme": "אוטומטי (מערכת)",
                        "language_preference": "העדפת שפה",
                        "business_settings": "הגדרות עסק",
                        "studio_name": "שם הסטודיו",
                        "currency_symbol": "סמל מטבע",
                        "default_session_duration": "משך פגישה ברירת מחדל (שעות)",
                        "inventory_settings": "הגדרות מלאי",
                        "default_low_stock_alert": "סף התראת מלאי נמוך ברירת מחדל",
                        "low_stock_help": "תקבל התראה כאשר הפריטים יגיעו לכמות זו",
                        "auto_deduct_materials": "הפחת חומרים אוטומטית לאחר פגישות",
                        "notifications": "התראות",
                        "enable_notifications": "אפשר התראות",
                        "notifications_help": "קבל התראות על פגישות קרובות",
                        "session_reminder": "תזכורת פגישה (שעות לפני)",
                        "reminder_help": "תקבל התראה כמה שעות לפני תחילת הפגישה",
                        "test_notifications": "בדוק התראות",
                        "data_management": "ניהול נתונים",
                        "auto_save": "שמירה אוטומטית של שינויים",
                        "auto_save_help": "שינויים נשמרים אוטומטית בדפדפן שלך",
                        "backup_all_data": "גיבוי כל הנתונים",
                        "import_data": "ייבוא נתונים",
                        "clear_all_data": "נקה את כל הנתונים",
                        "about": "אודות",
                        "about_description": "מערכת ניהול מקצועית לסטודיו קעקועים",
                        "made_with": "נעשה עם",
                        "for_artists": "לאמני קעקועים ברחבי העולם",
