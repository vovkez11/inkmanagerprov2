        ...
        class InkManagerPro {
            constructor() {
                this.clients = JSON.parse(localStorage.getItem('inkmanager_clients')) || [];
                this.sessions = JSON.parse(localStorage.getItem('inkmanager_sessions')) || [];
                this.inventory = JSON.parse(localStorage.getItem('inkmanager_inventory')) || [];
                this.inventoryFilter = localStorage.getItem('inkmanager_inventoryFilter') || 'all';
                this.inventorySort = JSON.parse(localStorage.getItem('inkmanager_inventorySort') || '{"key":"name","dir":"asc"}');
                this.inventorySearchQuery = '';
                this.selectedInventory = new Set();
                this.sidebarCollapsed = localStorage.getItem('inkmanager_sidebarCollapsed') === 'true';
                ...
                this.currentLanguage = localStorage.getItem('inkmanager_language') || 'en';
            ...
            saveData() {
                localStorage.setItem('inkmanager_clients', JSON.stringify(this.clients));
                localStorage.setItem('inkmanager_sessions', JSON.stringify(this.sessions));
                localStorage.setItem('inkmanager_inventory', JSON.stringify(this.inventory));
            }
        ...
        console.log('🚀 InkManager Pro Complete Rewritten Version - Ready!');
